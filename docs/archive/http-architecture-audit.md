...
**Scope:** `packages/http-api-projector/src/{project,layers,preset,verbs,adapter}.ts` + `packages/api-tree/src/{node,tags}.ts`  
**Date:** 2026-07-09  
...
**Where it lives:** `buildRoutes()` in `packages/http-api-projector/src/project.ts:181-341`.
...
**Where it lives:** `packages/http-api-projector/src/layers.ts`.
