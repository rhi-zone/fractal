...
export default withMermaid(
  defineConfig({
    ...
    themeConfig: {
      ...
      sidebar: [
        {
          ...
          items: [
            ...
            { text: "Core Concepts (Type IR)", link: "/guide/core-concepts" },
            ...
            { text: "Framework (HTTP/MCP/CLI/GraphQL)", link: "/guide/framework" },
        ...
        },
        {
          ...
          items: [
            ...
            { text: "Kinds", link: "/reference/type-ir/kinds" },
      ...
      socialLinks: [{ icon: "github", link: "https://github.com/rhi-zone/fractal" }],
      search: {
        provider: "local",
      },
      editLink: {
