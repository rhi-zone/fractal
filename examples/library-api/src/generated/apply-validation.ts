...
export const wireValidators = {
  "books\u0000books/list http": (function () {
    const __ref0 = {"shape":{"kind":"unknown"},"meta":{"$comment":"TODO(type-ir): unhandled type — unsupported (unknown)"}} as any;
    function parse(wire: any) {
      const path: string[] = [];
      void path;
      const errs: ValidationError[] = [];
      if (!(true)) { errs.push({ kind: "type", path: path, expected: __ref0, actual: __inferTypeRef(wire) }); }
  ...
  "books\u0000books/add http": (function () {
    ...
    return { parse: parse } as unknown as {
      parse: (wire: unknown) => { kind: "ok"; value: { title: string; author: string; genre: string } } | { kind: "err"; errors: ValidationError[] };
    };
  })(),
  "books\u0000books/:bookId/read http": (function () {
    ...
    return { parse: parse } as unknown as {
      parse: (wire: unknown) => { kind: "ok"; value: { bookId: string } } | { kind: "err"; errors: ValidationError[] };
    };
  })(),
  "books\u0000books/:bookId/replace http": (function () {
    ...
    return { parse: parse } as unknown as {
      parse: (wire: unknown) => { kind: "ok"; value: { bookId: string; title?: string; author?: string; genre?: string } } | { kind: "err"; errors: ValidationError[] };
    };
  })(),
  ...
  "books\u0000books/:bookId/checkout/reserve http": (function () {
    ...
    return { parse: parse } as unknown as {
      parse: (wire: unknown) => { kind: "ok"; value: { bookId: string; patronId: string } } | { kind: "err"; errors: ValidationError[] };
    };
  })(),
  "books\u0000catalog/search http": (function () {
    ...
    return { parse: parse } as unknown as {
      parse: (wire: unknown) => { kind: "ok"; value: { q?: string } } | { kind: "err"; errors: ValidationError[] };
    };
  })(),
  "books\u0000catalog/genres http": (function () {
    ...
    return { parse: parse } as unknown as {
      parse: (wire: unknown) => { kind: "ok"; value: { prefix?: string } } | { kind: "err"; errors: ValidationError[] };
    };
  })(),
}
