...
export const wireValidators = {
  "books\u0000books/list http": (function () {
    function parse(wire: any) {
      ...
      void path;
      const errs: ValidationError[] = [];
      if (errs.length > 0) { return { kind: "err" as const, errors: errs }; }
  ...
  "books\u0000books/add http": (function () {
    ...
    return { parse: parse, hookFields: [] } as unknown as {
      parse: (wire: unknown, hooks?: Readonly<Record<string, (w: unknown) => unknown>>) => { kind: "ok"; value: { title: string; author: string; genre: string } } | { kind: "err"; errors: ValidationError[] };
      hookFields: readonly string[];
    };
  })(),
  "books\u0000books/:bookId/read http": (function () {
    ...
    return { parse: parse, hookFields: [] } as unknown as {
      parse: (wire: unknown, hooks?: Readonly<Record<string, (w: unknown) => unknown>>) => { kind: "ok"; value: { bookId: string } } | { kind: "err"; errors: ValidationError[] };
      hookFields: readonly string[];
    };
  })(),
  "books\u0000books/:bookId/replace http": (function () {
    ...
    return { parse: parse, hookFields: [] } as unknown as {
      parse: (wire: unknown, hooks?: Readonly<Record<string, (w: unknown) => unknown>>) => { kind: "ok"; value: { bookId: string; title?: string; author?: string; genre?: string } } | { kind: "err"; errors: ValidationError[] };
      hookFields: readonly string[];
    };
  })(),
  ...
  "books\u0000books/:bookId/checkout/reserve http": (function () {
    ...
    return { parse: parse, hookFields: [] } as unknown as {
      parse: (wire: unknown, hooks?: Readonly<Record<string, (w: unknown) => unknown>>) => { kind: "ok"; value: { bookId: string; patronId: string } } | { kind: "err"; errors: ValidationError[] };
      hookFields: readonly string[];
    };
  })(),
  "books\u0000catalog/search http": (function () {
    ...
    return { parse: parse, hookFields: [] } as unknown as {
      parse: (wire: unknown, hooks?: Readonly<Record<string, (w: unknown) => unknown>>) => { kind: "ok"; value: { q?: string } } | { kind: "err"; errors: ValidationError[] };
      hookFields: readonly string[];
    };
  })(),
  "books\u0000catalog/genres http": (function () {
    ...
    return { parse: parse, hookFields: [] } as unknown as {
      parse: (wire: unknown, hooks?: Readonly<Record<string, (w: unknown) => unknown>>) => { kind: "ok"; value: { prefix?: string } } | { kind: "err"; errors: ValidationError[] };
      hookFields: readonly string[];
    };
  })(),
}
...
export const wireValidatorsByKey = {
  "books": {
    ...
    "books/:bookId/checkout/start": { "http": wireValidators["books\u0000books/:bookId/checkout/start http"] },
    "books/:bookId/checkout/reserve": { "http": wireValidators["books\u0000books/:bookId/checkout/reserve http"] },
