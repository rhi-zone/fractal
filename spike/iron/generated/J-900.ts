...
const h301 = route("POST", path(lit("res301")), bodySchema, async (ctx) => json({ id: 301, name: ctx.input.name, qty: ctx.input.qty }))
...
const h305 = route("PUT", path(lit("res305")), bodySchema, async (ctx) => json({ id: 305, name: ctx.input.name, qty: ctx.input.qty }))
...
const h313 = route("POST", path(lit("res313")), bodySchema, async (ctx) => json({ id: 313, name: ctx.input.name, qty: ctx.input.qty }))
...
const h317 = route("PUT", path(lit("res317")), bodySchema, async (ctx) => json({ id: 317, name: ctx.input.name, qty: ctx.input.qty }))
...
const h325 = route("POST", path(lit("res325")), bodySchema, async (ctx) => json({ id: 325, name: ctx.input.name, qty: ctx.input.qty }))
...
const h329 = route("PUT", path(lit("res329")), bodySchema, async (ctx) => json({ id: 329, name: ctx.input.name, qty: ctx.input.qty }))
...
const h337 = route("POST", path(lit("res337")), bodySchema, async (ctx) => json({ id: 337, name: ctx.input.name, qty: ctx.input.qty }))
...
const h341 = route("PUT", path(lit("res341")), bodySchema, async (ctx) => json({ id: 341, name: ctx.input.name, qty: ctx.input.qty }))
...
const h349 = route("POST", path(lit("res349")), bodySchema, async (ctx) => json({ id: 349, name: ctx.input.name, qty: ctx.input.qty }))
...
const h353 = route("PUT", path(lit("res353")), bodySchema, async (ctx) => json({ id: 353, name: ctx.input.name, qty: ctx.input.qty }))
...
const h361 = route("POST", path(lit("res361")), bodySchema, async (ctx) => json({ id: 361, name: ctx.input.name, qty: ctx.input.qty }))
...
const h365 = route("PUT", path(lit("res365")), bodySchema, async (ctx) => json({ id: 365, name: ctx.input.name, qty: ctx.input.qty }))
...
const h373 = route("POST", path(lit("res373")), bodySchema, async (ctx) => json({ id: 373, name: ctx.input.name, qty: ctx.input.qty }))
...
const h377 = route("PUT", path(lit("res377")), bodySchema, async (ctx) => json({ id: 377, name: ctx.input.name, qty: ctx.input.qty }))
...
const h385 = route("POST", path(lit("res385")), bodySchema, async (ctx) => json({ id: 385, name: ctx.input.name, qty: ctx.input.qty }))
...
const h389 = route("PUT", path(lit("res389")), bodySchema, async (ctx) => json({ id: 389, name: ctx.input.name, qty: ctx.input.qty }))
...
const h397 = route("POST", path(lit("res397")), bodySchema, async (ctx) => json({ id: 397, name: ctx.input.name, qty: ctx.input.qty }))
...
const h401 = route("PUT", path(lit("res401")), bodySchema, async (ctx) => json({ id: 401, name: ctx.input.name, qty: ctx.input.qty }))
...
const h409 = route("POST", path(lit("res409")), bodySchema, async (ctx) => json({ id: 409, name: ctx.input.name, qty: ctx.input.qty }))
...
const h413 = route("PUT", path(lit("res413")), bodySchema, async (ctx) => json({ id: 413, name: ctx.input.name, qty: ctx.input.qty }))
...
const h421 = route("POST", path(lit("res421")), bodySchema, async (ctx) => json({ id: 421, name: ctx.input.name, qty: ctx.input.qty }))
...
const h425 = route("PUT", path(lit("res425")), bodySchema, async (ctx) => json({ id: 425, name: ctx.input.name, qty: ctx.input.qty }))
...
const h433 = route("POST", path(lit("res433")), bodySchema, async (ctx) => json({ id: 433, name: ctx.input.name, qty: ctx.input.qty }))
...
const h437 = route("PUT", path(lit("res437")), bodySchema, async (ctx) => json({ id: 437, name: ctx.input.name, qty: ctx.input.qty }))
...
const h445 = route("POST", path(lit("res445")), bodySchema, async (ctx) => json({ id: 445, name: ctx.input.name, qty: ctx.input.qty }))
...
const h449 = route("PUT", path(lit("res449")), bodySchema, async (ctx) => json({ id: 449, name: ctx.input.name, qty: ctx.input.qty }))
...
const h457 = route("POST", path(lit("res457")), bodySchema, async (ctx) => json({ id: 457, name: ctx.input.name, qty: ctx.input.qty }))
...
const h461 = route("PUT", path(lit("res461")), bodySchema, async (ctx) => json({ id: 461, name: ctx.input.name, qty: ctx.input.qty }))
...
const h469 = route("POST", path(lit("res469")), bodySchema, async (ctx) => json({ id: 469, name: ctx.input.name, qty: ctx.input.qty }))
...
const h473 = route("PUT", path(lit("res473")), bodySchema, async (ctx) => json({ id: 473, name: ctx.input.name, qty: ctx.input.qty }))
...
const h481 = route("POST", path(lit("res481")), bodySchema, async (ctx) => json({ id: 481, name: ctx.input.name, qty: ctx.input.qty }))
...
const h485 = route("PUT", path(lit("res485")), bodySchema, async (ctx) => json({ id: 485, name: ctx.input.name, qty: ctx.input.qty }))
...
const h493 = route("POST", path(lit("res493")), bodySchema, async (ctx) => json({ id: 493, name: ctx.input.name, qty: ctx.input.qty }))
...
const h497 = route("PUT", path(lit("res497")), bodySchema, async (ctx) => json({ id: 497, name: ctx.input.name, qty: ctx.input.qty }))
...
const h505 = route("POST", path(lit("res505")), bodySchema, async (ctx) => json({ id: 505, name: ctx.input.name, qty: ctx.input.qty }))
...
const h509 = route("PUT", path(lit("res509")), bodySchema, async (ctx) => json({ id: 509, name: ctx.input.name, qty: ctx.input.qty }))
...
const h517 = route("POST", path(lit("res517")), bodySchema, async (ctx) => json({ id: 517, name: ctx.input.name, qty: ctx.input.qty }))
...
const h521 = route("PUT", path(lit("res521")), bodySchema, async (ctx) => json({ id: 521, name: ctx.input.name, qty: ctx.input.qty }))
...
const h529 = route("POST", path(lit("res529")), bodySchema, async (ctx) => json({ id: 529, name: ctx.input.name, qty: ctx.input.qty }))
...
const h533 = route("PUT", path(lit("res533")), bodySchema, async (ctx) => json({ id: 533, name: ctx.input.name, qty: ctx.input.qty }))
...
const h541 = route("POST", path(lit("res541")), bodySchema, async (ctx) => json({ id: 541, name: ctx.input.name, qty: ctx.input.qty }))
...
const h545 = route("PUT", path(lit("res545")), bodySchema, async (ctx) => json({ id: 545, name: ctx.input.name, qty: ctx.input.qty }))
...
const h553 = route("POST", path(lit("res553")), bodySchema, async (ctx) => json({ id: 553, name: ctx.input.name, qty: ctx.input.qty }))
...
const h557 = route("PUT", path(lit("res557")), bodySchema, async (ctx) => json({ id: 557, name: ctx.input.name, qty: ctx.input.qty }))
...
const h565 = route("POST", path(lit("res565")), bodySchema, async (ctx) => json({ id: 565, name: ctx.input.name, qty: ctx.input.qty }))
...
const h569 = route("PUT", path(lit("res569")), bodySchema, async (ctx) => json({ id: 569, name: ctx.input.name, qty: ctx.input.qty }))
...
const h577 = route("POST", path(lit("res577")), bodySchema, async (ctx) => json({ id: 577, name: ctx.input.name, qty: ctx.input.qty }))
...
const h581 = route("PUT", path(lit("res581")), bodySchema, async (ctx) => json({ id: 581, name: ctx.input.name, qty: ctx.input.qty }))
...
const h589 = route("POST", path(lit("res589")), bodySchema, async (ctx) => json({ id: 589, name: ctx.input.name, qty: ctx.input.qty }))
...
const h593 = route("PUT", path(lit("res593")), bodySchema, async (ctx) => json({ id: 593, name: ctx.input.name, qty: ctx.input.qty }))
...
const h600 = route("GET", path(lit("res600"), param("id")), async (ctx) => json({ id: 600, key: ctx.params.id }))
const h601 = route("POST", path(lit("res601")), bodySchema, async (ctx) => json({ id: 601, name: ctx.input.name, qty: ctx.input.qty }))
const h602 = route("PUT", path(lit("res602"), param("id")), async (ctx) => json({ id: 602, key: ctx.params.id }))
const h603 = route("GET", path(lit("res603")), async (ctx) => json({ id: 603, key: "res603" }))
const h604 = route("POST", path(lit("res604"), param("id")), async (ctx) => json({ id: 604, key: ctx.params.id }))
const h605 = route("PUT", path(lit("res605")), bodySchema, async (ctx) => json({ id: 605, name: ctx.input.name, qty: ctx.input.qty }))
const h606 = route("GET", path(lit("res606"), param("id")), async (ctx) => json({ id: 606, key: ctx.params.id }))
const h607 = route("POST", path(lit("res607")), async (ctx) => json({ id: 607, key: "res607" }))
const h608 = route("PUT", path(lit("res608"), param("id")), async (ctx) => json({ id: 608, key: ctx.params.id }))
const h609 = route("GET", path(lit("res609")), async (ctx) => json({ id: 609, key: "res609" }))
const h610 = route("POST", path(lit("res610"), param("id")), async (ctx) => json({ id: 610, key: ctx.params.id }))
const h611 = route("PUT", path(lit("res611")), async (ctx) => json({ id: 611, key: "res611" }))
const h612 = route("GET", path(lit("res612"), param("id")), async (ctx) => json({ id: 612, key: ctx.params.id }))
const h613 = route("POST", path(lit("res613")), bodySchema, async (ctx) => json({ id: 613, name: ctx.input.name, qty: ctx.input.qty }))
const h614 = route("PUT", path(lit("res614"), param("id")), async (ctx) => json({ id: 614, key: ctx.params.id }))
const h615 = route("GET", path(lit("res615")), async (ctx) => json({ id: 615, key: "res615" }))
const h616 = route("POST", path(lit("res616"), param("id")), async (ctx) => json({ id: 616, key: ctx.params.id }))
const h617 = route("PUT", path(lit("res617")), bodySchema, async (ctx) => json({ id: 617, name: ctx.input.name, qty: ctx.input.qty }))
const h618 = route("GET", path(lit("res618"), param("id")), async (ctx) => json({ id: 618, key: ctx.params.id }))
const h619 = route("POST", path(lit("res619")), async (ctx) => json({ id: 619, key: "res619" }))
const h620 = route("PUT", path(lit("res620"), param("id")), async (ctx) => json({ id: 620, key: ctx.params.id }))
const h621 = route("GET", path(lit("res621")), async (ctx) => json({ id: 621, key: "res621" }))
const h622 = route("POST", path(lit("res622"), param("id")), async (ctx) => json({ id: 622, key: ctx.params.id }))
const h623 = route("PUT", path(lit("res623")), async (ctx) => json({ id: 623, key: "res623" }))
const h624 = route("GET", path(lit("res624"), param("id")), async (ctx) => json({ id: 624, key: ctx.params.id }))
const h625 = route("POST", path(lit("res625")), bodySchema, async (ctx) => json({ id: 625, name: ctx.input.name, qty: ctx.input.qty }))
const h626 = route("PUT", path(lit("res626"), param("id")), async (ctx) => json({ id: 626, key: ctx.params.id }))
const h627 = route("GET", path(lit("res627")), async (ctx) => json({ id: 627, key: "res627" }))
const h628 = route("POST", path(lit("res628"), param("id")), async (ctx) => json({ id: 628, key: ctx.params.id }))
const h629 = route("PUT", path(lit("res629")), bodySchema, async (ctx) => json({ id: 629, name: ctx.input.name, qty: ctx.input.qty }))
const h630 = route("GET", path(lit("res630"), param("id")), async (ctx) => json({ id: 630, key: ctx.params.id }))
const h631 = route("POST", path(lit("res631")), async (ctx) => json({ id: 631, key: "res631" }))
const h632 = route("PUT", path(lit("res632"), param("id")), async (ctx) => json({ id: 632, key: ctx.params.id }))
const h633 = route("GET", path(lit("res633")), async (ctx) => json({ id: 633, key: "res633" }))
const h634 = route("POST", path(lit("res634"), param("id")), async (ctx) => json({ id: 634, key: ctx.params.id }))
const h635 = route("PUT", path(lit("res635")), async (ctx) => json({ id: 635, key: "res635" }))
const h636 = route("GET", path(lit("res636"), param("id")), async (ctx) => json({ id: 636, key: ctx.params.id }))
const h637 = route("POST", path(lit("res637")), bodySchema, async (ctx) => json({ id: 637, name: ctx.input.name, qty: ctx.input.qty }))
const h638 = route("PUT", path(lit("res638"), param("id")), async (ctx) => json({ id: 638, key: ctx.params.id }))
const h639 = route("GET", path(lit("res639")), async (ctx) => json({ id: 639, key: "res639" }))
const h640 = route("POST", path(lit("res640"), param("id")), async (ctx) => json({ id: 640, key: ctx.params.id }))
const h641 = route("PUT", path(lit("res641")), bodySchema, async (ctx) => json({ id: 641, name: ctx.input.name, qty: ctx.input.qty }))
const h642 = route("GET", path(lit("res642"), param("id")), async (ctx) => json({ id: 642, key: ctx.params.id }))
const h643 = route("POST", path(lit("res643")), async (ctx) => json({ id: 643, key: "res643" }))
const h644 = route("PUT", path(lit("res644"), param("id")), async (ctx) => json({ id: 644, key: ctx.params.id }))
const h645 = route("GET", path(lit("res645")), async (ctx) => json({ id: 645, key: "res645" }))
const h646 = route("POST", path(lit("res646"), param("id")), async (ctx) => json({ id: 646, key: ctx.params.id }))
const h647 = route("PUT", path(lit("res647")), async (ctx) => json({ id: 647, key: "res647" }))
const h648 = route("GET", path(lit("res648"), param("id")), async (ctx) => json({ id: 648, key: ctx.params.id }))
const h649 = route("POST", path(lit("res649")), bodySchema, async (ctx) => json({ id: 649, name: ctx.input.name, qty: ctx.input.qty }))
const h650 = route("PUT", path(lit("res650"), param("id")), async (ctx) => json({ id: 650, key: ctx.params.id }))
const h651 = route("GET", path(lit("res651")), async (ctx) => json({ id: 651, key: "res651" }))
const h652 = route("POST", path(lit("res652"), param("id")), async (ctx) => json({ id: 652, key: ctx.params.id }))
const h653 = route("PUT", path(lit("res653")), bodySchema, async (ctx) => json({ id: 653, name: ctx.input.name, qty: ctx.input.qty }))
const h654 = route("GET", path(lit("res654"), param("id")), async (ctx) => json({ id: 654, key: ctx.params.id }))
const h655 = route("POST", path(lit("res655")), async (ctx) => json({ id: 655, key: "res655" }))
const h656 = route("PUT", path(lit("res656"), param("id")), async (ctx) => json({ id: 656, key: ctx.params.id }))
const h657 = route("GET", path(lit("res657")), async (ctx) => json({ id: 657, key: "res657" }))
const h658 = route("POST", path(lit("res658"), param("id")), async (ctx) => json({ id: 658, key: ctx.params.id }))
const h659 = route("PUT", path(lit("res659")), async (ctx) => json({ id: 659, key: "res659" }))
const h660 = route("GET", path(lit("res660"), param("id")), async (ctx) => json({ id: 660, key: ctx.params.id }))
const h661 = route("POST", path(lit("res661")), bodySchema, async (ctx) => json({ id: 661, name: ctx.input.name, qty: ctx.input.qty }))
const h662 = route("PUT", path(lit("res662"), param("id")), async (ctx) => json({ id: 662, key: ctx.params.id }))
const h663 = route("GET", path(lit("res663")), async (ctx) => json({ id: 663, key: "res663" }))
const h664 = route("POST", path(lit("res664"), param("id")), async (ctx) => json({ id: 664, key: ctx.params.id }))
const h665 = route("PUT", path(lit("res665")), bodySchema, async (ctx) => json({ id: 665, name: ctx.input.name, qty: ctx.input.qty }))
const h666 = route("GET", path(lit("res666"), param("id")), async (ctx) => json({ id: 666, key: ctx.params.id }))
const h667 = route("POST", path(lit("res667")), async (ctx) => json({ id: 667, key: "res667" }))
const h668 = route("PUT", path(lit("res668"), param("id")), async (ctx) => json({ id: 668, key: ctx.params.id }))
const h669 = route("GET", path(lit("res669")), async (ctx) => json({ id: 669, key: "res669" }))
const h670 = route("POST", path(lit("res670"), param("id")), async (ctx) => json({ id: 670, key: ctx.params.id }))
const h671 = route("PUT", path(lit("res671")), async (ctx) => json({ id: 671, key: "res671" }))
const h672 = route("GET", path(lit("res672"), param("id")), async (ctx) => json({ id: 672, key: ctx.params.id }))
const h673 = route("POST", path(lit("res673")), bodySchema, async (ctx) => json({ id: 673, name: ctx.input.name, qty: ctx.input.qty }))
const h674 = route("PUT", path(lit("res674"), param("id")), async (ctx) => json({ id: 674, key: ctx.params.id }))
const h675 = route("GET", path(lit("res675")), async (ctx) => json({ id: 675, key: "res675" }))
const h676 = route("POST", path(lit("res676"), param("id")), async (ctx) => json({ id: 676, key: ctx.params.id }))
const h677 = route("PUT", path(lit("res677")), bodySchema, async (ctx) => json({ id: 677, name: ctx.input.name, qty: ctx.input.qty }))
const h678 = route("GET", path(lit("res678"), param("id")), async (ctx) => json({ id: 678, key: ctx.params.id }))
const h679 = route("POST", path(lit("res679")), async (ctx) => json({ id: 679, key: "res679" }))
const h680 = route("PUT", path(lit("res680"), param("id")), async (ctx) => json({ id: 680, key: ctx.params.id }))
const h681 = route("GET", path(lit("res681")), async (ctx) => json({ id: 681, key: "res681" }))
const h682 = route("POST", path(lit("res682"), param("id")), async (ctx) => json({ id: 682, key: ctx.params.id }))
const h683 = route("PUT", path(lit("res683")), async (ctx) => json({ id: 683, key: "res683" }))
const h684 = route("GET", path(lit("res684"), param("id")), async (ctx) => json({ id: 684, key: ctx.params.id }))
const h685 = route("POST", path(lit("res685")), bodySchema, async (ctx) => json({ id: 685, name: ctx.input.name, qty: ctx.input.qty }))
const h686 = route("PUT", path(lit("res686"), param("id")), async (ctx) => json({ id: 686, key: ctx.params.id }))
const h687 = route("GET", path(lit("res687")), async (ctx) => json({ id: 687, key: "res687" }))
const h688 = route("POST", path(lit("res688"), param("id")), async (ctx) => json({ id: 688, key: ctx.params.id }))
const h689 = route("PUT", path(lit("res689")), bodySchema, async (ctx) => json({ id: 689, name: ctx.input.name, qty: ctx.input.qty }))
const h690 = route("GET", path(lit("res690"), param("id")), async (ctx) => json({ id: 690, key: ctx.params.id }))
const h691 = route("POST", path(lit("res691")), async (ctx) => json({ id: 691, key: "res691" }))
const h692 = route("PUT", path(lit("res692"), param("id")), async (ctx) => json({ id: 692, key: ctx.params.id }))
const h693 = route("GET", path(lit("res693")), async (ctx) => json({ id: 693, key: "res693" }))
const h694 = route("POST", path(lit("res694"), param("id")), async (ctx) => json({ id: 694, key: ctx.params.id }))
const h695 = route("PUT", path(lit("res695")), async (ctx) => json({ id: 695, key: "res695" }))
const h696 = route("GET", path(lit("res696"), param("id")), async (ctx) => json({ id: 696, key: ctx.params.id }))
const h697 = route("POST", path(lit("res697")), bodySchema, async (ctx) => json({ id: 697, name: ctx.input.name, qty: ctx.input.qty }))
const h698 = route("PUT", path(lit("res698"), param("id")), async (ctx) => json({ id: 698, key: ctx.params.id }))
const h699 = route("GET", path(lit("res699")), async (ctx) => json({ id: 699, key: "res699" }))
const h700 = route("POST", path(lit("res700"), param("id")), async (ctx) => json({ id: 700, key: ctx.params.id }))
const h701 = route("PUT", path(lit("res701")), bodySchema, async (ctx) => json({ id: 701, name: ctx.input.name, qty: ctx.input.qty }))
const h702 = route("GET", path(lit("res702"), param("id")), async (ctx) => json({ id: 702, key: ctx.params.id }))
const h703 = route("POST", path(lit("res703")), async (ctx) => json({ id: 703, key: "res703" }))
const h704 = route("PUT", path(lit("res704"), param("id")), async (ctx) => json({ id: 704, key: ctx.params.id }))
const h705 = route("GET", path(lit("res705")), async (ctx) => json({ id: 705, key: "res705" }))
const h706 = route("POST", path(lit("res706"), param("id")), async (ctx) => json({ id: 706, key: ctx.params.id }))
const h707 = route("PUT", path(lit("res707")), async (ctx) => json({ id: 707, key: "res707" }))
const h708 = route("GET", path(lit("res708"), param("id")), async (ctx) => json({ id: 708, key: ctx.params.id }))
const h709 = route("POST", path(lit("res709")), bodySchema, async (ctx) => json({ id: 709, name: ctx.input.name, qty: ctx.input.qty }))
const h710 = route("PUT", path(lit("res710"), param("id")), async (ctx) => json({ id: 710, key: ctx.params.id }))
const h711 = route("GET", path(lit("res711")), async (ctx) => json({ id: 711, key: "res711" }))
const h712 = route("POST", path(lit("res712"), param("id")), async (ctx) => json({ id: 712, key: ctx.params.id }))
const h713 = route("PUT", path(lit("res713")), bodySchema, async (ctx) => json({ id: 713, name: ctx.input.name, qty: ctx.input.qty }))
const h714 = route("GET", path(lit("res714"), param("id")), async (ctx) => json({ id: 714, key: ctx.params.id }))
const h715 = route("POST", path(lit("res715")), async (ctx) => json({ id: 715, key: "res715" }))
const h716 = route("PUT", path(lit("res716"), param("id")), async (ctx) => json({ id: 716, key: ctx.params.id }))
const h717 = route("GET", path(lit("res717")), async (ctx) => json({ id: 717, key: "res717" }))
const h718 = route("POST", path(lit("res718"), param("id")), async (ctx) => json({ id: 718, key: ctx.params.id }))
const h719 = route("PUT", path(lit("res719")), async (ctx) => json({ id: 719, key: "res719" }))
const h720 = route("GET", path(lit("res720"), param("id")), async (ctx) => json({ id: 720, key: ctx.params.id }))
const h721 = route("POST", path(lit("res721")), bodySchema, async (ctx) => json({ id: 721, name: ctx.input.name, qty: ctx.input.qty }))
const h722 = route("PUT", path(lit("res722"), param("id")), async (ctx) => json({ id: 722, key: ctx.params.id }))
const h723 = route("GET", path(lit("res723")), async (ctx) => json({ id: 723, key: "res723" }))
const h724 = route("POST", path(lit("res724"), param("id")), async (ctx) => json({ id: 724, key: ctx.params.id }))
const h725 = route("PUT", path(lit("res725")), bodySchema, async (ctx) => json({ id: 725, name: ctx.input.name, qty: ctx.input.qty }))
const h726 = route("GET", path(lit("res726"), param("id")), async (ctx) => json({ id: 726, key: ctx.params.id }))
const h727 = route("POST", path(lit("res727")), async (ctx) => json({ id: 727, key: "res727" }))
const h728 = route("PUT", path(lit("res728"), param("id")), async (ctx) => json({ id: 728, key: ctx.params.id }))
const h729 = route("GET", path(lit("res729")), async (ctx) => json({ id: 729, key: "res729" }))
const h730 = route("POST", path(lit("res730"), param("id")), async (ctx) => json({ id: 730, key: ctx.params.id }))
const h731 = route("PUT", path(lit("res731")), async (ctx) => json({ id: 731, key: "res731" }))
const h732 = route("GET", path(lit("res732"), param("id")), async (ctx) => json({ id: 732, key: ctx.params.id }))
const h733 = route("POST", path(lit("res733")), bodySchema, async (ctx) => json({ id: 733, name: ctx.input.name, qty: ctx.input.qty }))
const h734 = route("PUT", path(lit("res734"), param("id")), async (ctx) => json({ id: 734, key: ctx.params.id }))
const h735 = route("GET", path(lit("res735")), async (ctx) => json({ id: 735, key: "res735" }))
const h736 = route("POST", path(lit("res736"), param("id")), async (ctx) => json({ id: 736, key: ctx.params.id }))
const h737 = route("PUT", path(lit("res737")), bodySchema, async (ctx) => json({ id: 737, name: ctx.input.name, qty: ctx.input.qty }))
const h738 = route("GET", path(lit("res738"), param("id")), async (ctx) => json({ id: 738, key: ctx.params.id }))
const h739 = route("POST", path(lit("res739")), async (ctx) => json({ id: 739, key: "res739" }))
const h740 = route("PUT", path(lit("res740"), param("id")), async (ctx) => json({ id: 740, key: ctx.params.id }))
const h741 = route("GET", path(lit("res741")), async (ctx) => json({ id: 741, key: "res741" }))
const h742 = route("POST", path(lit("res742"), param("id")), async (ctx) => json({ id: 742, key: ctx.params.id }))
const h743 = route("PUT", path(lit("res743")), async (ctx) => json({ id: 743, key: "res743" }))
const h744 = route("GET", path(lit("res744"), param("id")), async (ctx) => json({ id: 744, key: ctx.params.id }))
const h745 = route("POST", path(lit("res745")), bodySchema, async (ctx) => json({ id: 745, name: ctx.input.name, qty: ctx.input.qty }))
const h746 = route("PUT", path(lit("res746"), param("id")), async (ctx) => json({ id: 746, key: ctx.params.id }))
const h747 = route("GET", path(lit("res747")), async (ctx) => json({ id: 747, key: "res747" }))
const h748 = route("POST", path(lit("res748"), param("id")), async (ctx) => json({ id: 748, key: ctx.params.id }))
const h749 = route("PUT", path(lit("res749")), bodySchema, async (ctx) => json({ id: 749, name: ctx.input.name, qty: ctx.input.qty }))
const h750 = route("GET", path(lit("res750"), param("id")), async (ctx) => json({ id: 750, key: ctx.params.id }))
const h751 = route("POST", path(lit("res751")), async (ctx) => json({ id: 751, key: "res751" }))
const h752 = route("PUT", path(lit("res752"), param("id")), async (ctx) => json({ id: 752, key: ctx.params.id }))
const h753 = route("GET", path(lit("res753")), async (ctx) => json({ id: 753, key: "res753" }))
const h754 = route("POST", path(lit("res754"), param("id")), async (ctx) => json({ id: 754, key: ctx.params.id }))
const h755 = route("PUT", path(lit("res755")), async (ctx) => json({ id: 755, key: "res755" }))
const h756 = route("GET", path(lit("res756"), param("id")), async (ctx) => json({ id: 756, key: ctx.params.id }))
const h757 = route("POST", path(lit("res757")), bodySchema, async (ctx) => json({ id: 757, name: ctx.input.name, qty: ctx.input.qty }))
const h758 = route("PUT", path(lit("res758"), param("id")), async (ctx) => json({ id: 758, key: ctx.params.id }))
const h759 = route("GET", path(lit("res759")), async (ctx) => json({ id: 759, key: "res759" }))
const h760 = route("POST", path(lit("res760"), param("id")), async (ctx) => json({ id: 760, key: ctx.params.id }))
const h761 = route("PUT", path(lit("res761")), bodySchema, async (ctx) => json({ id: 761, name: ctx.input.name, qty: ctx.input.qty }))
const h762 = route("GET", path(lit("res762"), param("id")), async (ctx) => json({ id: 762, key: ctx.params.id }))
const h763 = route("POST", path(lit("res763")), async (ctx) => json({ id: 763, key: "res763" }))
const h764 = route("PUT", path(lit("res764"), param("id")), async (ctx) => json({ id: 764, key: ctx.params.id }))
const h765 = route("GET", path(lit("res765")), async (ctx) => json({ id: 765, key: "res765" }))
const h766 = route("POST", path(lit("res766"), param("id")), async (ctx) => json({ id: 766, key: ctx.params.id }))
const h767 = route("PUT", path(lit("res767")), async (ctx) => json({ id: 767, key: "res767" }))
const h768 = route("GET", path(lit("res768"), param("id")), async (ctx) => json({ id: 768, key: ctx.params.id }))
const h769 = route("POST", path(lit("res769")), bodySchema, async (ctx) => json({ id: 769, name: ctx.input.name, qty: ctx.input.qty }))
const h770 = route("PUT", path(lit("res770"), param("id")), async (ctx) => json({ id: 770, key: ctx.params.id }))
const h771 = route("GET", path(lit("res771")), async (ctx) => json({ id: 771, key: "res771" }))
const h772 = route("POST", path(lit("res772"), param("id")), async (ctx) => json({ id: 772, key: ctx.params.id }))
const h773 = route("PUT", path(lit("res773")), bodySchema, async (ctx) => json({ id: 773, name: ctx.input.name, qty: ctx.input.qty }))
const h774 = route("GET", path(lit("res774"), param("id")), async (ctx) => json({ id: 774, key: ctx.params.id }))
const h775 = route("POST", path(lit("res775")), async (ctx) => json({ id: 775, key: "res775" }))
const h776 = route("PUT", path(lit("res776"), param("id")), async (ctx) => json({ id: 776, key: ctx.params.id }))
const h777 = route("GET", path(lit("res777")), async (ctx) => json({ id: 777, key: "res777" }))
const h778 = route("POST", path(lit("res778"), param("id")), async (ctx) => json({ id: 778, key: ctx.params.id }))
const h779 = route("PUT", path(lit("res779")), async (ctx) => json({ id: 779, key: "res779" }))
const h780 = route("GET", path(lit("res780"), param("id")), async (ctx) => json({ id: 780, key: ctx.params.id }))
const h781 = route("POST", path(lit("res781")), bodySchema, async (ctx) => json({ id: 781, name: ctx.input.name, qty: ctx.input.qty }))
const h782 = route("PUT", path(lit("res782"), param("id")), async (ctx) => json({ id: 782, key: ctx.params.id }))
const h783 = route("GET", path(lit("res783")), async (ctx) => json({ id: 783, key: "res783" }))
const h784 = route("POST", path(lit("res784"), param("id")), async (ctx) => json({ id: 784, key: ctx.params.id }))
const h785 = route("PUT", path(lit("res785")), bodySchema, async (ctx) => json({ id: 785, name: ctx.input.name, qty: ctx.input.qty }))
const h786 = route("GET", path(lit("res786"), param("id")), async (ctx) => json({ id: 786, key: ctx.params.id }))
const h787 = route("POST", path(lit("res787")), async (ctx) => json({ id: 787, key: "res787" }))
const h788 = route("PUT", path(lit("res788"), param("id")), async (ctx) => json({ id: 788, key: ctx.params.id }))
const h789 = route("GET", path(lit("res789")), async (ctx) => json({ id: 789, key: "res789" }))
const h790 = route("POST", path(lit("res790"), param("id")), async (ctx) => json({ id: 790, key: ctx.params.id }))
const h791 = route("PUT", path(lit("res791")), async (ctx) => json({ id: 791, key: "res791" }))
const h792 = route("GET", path(lit("res792"), param("id")), async (ctx) => json({ id: 792, key: ctx.params.id }))
const h793 = route("POST", path(lit("res793")), bodySchema, async (ctx) => json({ id: 793, name: ctx.input.name, qty: ctx.input.qty }))
const h794 = route("PUT", path(lit("res794"), param("id")), async (ctx) => json({ id: 794, key: ctx.params.id }))
const h795 = route("GET", path(lit("res795")), async (ctx) => json({ id: 795, key: "res795" }))
const h796 = route("POST", path(lit("res796"), param("id")), async (ctx) => json({ id: 796, key: ctx.params.id }))
const h797 = route("PUT", path(lit("res797")), bodySchema, async (ctx) => json({ id: 797, name: ctx.input.name, qty: ctx.input.qty }))
const h798 = route("GET", path(lit("res798"), param("id")), async (ctx) => json({ id: 798, key: ctx.params.id }))
const h799 = route("POST", path(lit("res799")), async (ctx) => json({ id: 799, key: "res799" }))
const h800 = route("PUT", path(lit("res800"), param("id")), async (ctx) => json({ id: 800, key: ctx.params.id }))
const h801 = route("GET", path(lit("res801")), async (ctx) => json({ id: 801, key: "res801" }))
const h802 = route("POST", path(lit("res802"), param("id")), async (ctx) => json({ id: 802, key: ctx.params.id }))
const h803 = route("PUT", path(lit("res803")), async (ctx) => json({ id: 803, key: "res803" }))
const h804 = route("GET", path(lit("res804"), param("id")), async (ctx) => json({ id: 804, key: ctx.params.id }))
const h805 = route("POST", path(lit("res805")), bodySchema, async (ctx) => json({ id: 805, name: ctx.input.name, qty: ctx.input.qty }))
const h806 = route("PUT", path(lit("res806"), param("id")), async (ctx) => json({ id: 806, key: ctx.params.id }))
const h807 = route("GET", path(lit("res807")), async (ctx) => json({ id: 807, key: "res807" }))
const h808 = route("POST", path(lit("res808"), param("id")), async (ctx) => json({ id: 808, key: ctx.params.id }))
const h809 = route("PUT", path(lit("res809")), bodySchema, async (ctx) => json({ id: 809, name: ctx.input.name, qty: ctx.input.qty }))
const h810 = route("GET", path(lit("res810"), param("id")), async (ctx) => json({ id: 810, key: ctx.params.id }))
const h811 = route("POST", path(lit("res811")), async (ctx) => json({ id: 811, key: "res811" }))
const h812 = route("PUT", path(lit("res812"), param("id")), async (ctx) => json({ id: 812, key: ctx.params.id }))
const h813 = route("GET", path(lit("res813")), async (ctx) => json({ id: 813, key: "res813" }))
const h814 = route("POST", path(lit("res814"), param("id")), async (ctx) => json({ id: 814, key: ctx.params.id }))
const h815 = route("PUT", path(lit("res815")), async (ctx) => json({ id: 815, key: "res815" }))
const h816 = route("GET", path(lit("res816"), param("id")), async (ctx) => json({ id: 816, key: ctx.params.id }))
const h817 = route("POST", path(lit("res817")), bodySchema, async (ctx) => json({ id: 817, name: ctx.input.name, qty: ctx.input.qty }))
const h818 = route("PUT", path(lit("res818"), param("id")), async (ctx) => json({ id: 818, key: ctx.params.id }))
const h819 = route("GET", path(lit("res819")), async (ctx) => json({ id: 819, key: "res819" }))
const h820 = route("POST", path(lit("res820"), param("id")), async (ctx) => json({ id: 820, key: ctx.params.id }))
const h821 = route("PUT", path(lit("res821")), bodySchema, async (ctx) => json({ id: 821, name: ctx.input.name, qty: ctx.input.qty }))
const h822 = route("GET", path(lit("res822"), param("id")), async (ctx) => json({ id: 822, key: ctx.params.id }))
const h823 = route("POST", path(lit("res823")), async (ctx) => json({ id: 823, key: "res823" }))
const h824 = route("PUT", path(lit("res824"), param("id")), async (ctx) => json({ id: 824, key: ctx.params.id }))
const h825 = route("GET", path(lit("res825")), async (ctx) => json({ id: 825, key: "res825" }))
const h826 = route("POST", path(lit("res826"), param("id")), async (ctx) => json({ id: 826, key: ctx.params.id }))
const h827 = route("PUT", path(lit("res827")), async (ctx) => json({ id: 827, key: "res827" }))
const h828 = route("GET", path(lit("res828"), param("id")), async (ctx) => json({ id: 828, key: ctx.params.id }))
const h829 = route("POST", path(lit("res829")), bodySchema, async (ctx) => json({ id: 829, name: ctx.input.name, qty: ctx.input.qty }))
const h830 = route("PUT", path(lit("res830"), param("id")), async (ctx) => json({ id: 830, key: ctx.params.id }))
const h831 = route("GET", path(lit("res831")), async (ctx) => json({ id: 831, key: "res831" }))
const h832 = route("POST", path(lit("res832"), param("id")), async (ctx) => json({ id: 832, key: ctx.params.id }))
const h833 = route("PUT", path(lit("res833")), bodySchema, async (ctx) => json({ id: 833, name: ctx.input.name, qty: ctx.input.qty }))
const h834 = route("GET", path(lit("res834"), param("id")), async (ctx) => json({ id: 834, key: ctx.params.id }))
const h835 = route("POST", path(lit("res835")), async (ctx) => json({ id: 835, key: "res835" }))
const h836 = route("PUT", path(lit("res836"), param("id")), async (ctx) => json({ id: 836, key: ctx.params.id }))
const h837 = route("GET", path(lit("res837")), async (ctx) => json({ id: 837, key: "res837" }))
const h838 = route("POST", path(lit("res838"), param("id")), async (ctx) => json({ id: 838, key: ctx.params.id }))
const h839 = route("PUT", path(lit("res839")), async (ctx) => json({ id: 839, key: "res839" }))
const h840 = route("GET", path(lit("res840"), param("id")), async (ctx) => json({ id: 840, key: ctx.params.id }))
const h841 = route("POST", path(lit("res841")), bodySchema, async (ctx) => json({ id: 841, name: ctx.input.name, qty: ctx.input.qty }))
const h842 = route("PUT", path(lit("res842"), param("id")), async (ctx) => json({ id: 842, key: ctx.params.id }))
const h843 = route("GET", path(lit("res843")), async (ctx) => json({ id: 843, key: "res843" }))
const h844 = route("POST", path(lit("res844"), param("id")), async (ctx) => json({ id: 844, key: ctx.params.id }))
const h845 = route("PUT", path(lit("res845")), bodySchema, async (ctx) => json({ id: 845, name: ctx.input.name, qty: ctx.input.qty }))
const h846 = route("GET", path(lit("res846"), param("id")), async (ctx) => json({ id: 846, key: ctx.params.id }))
const h847 = route("POST", path(lit("res847")), async (ctx) => json({ id: 847, key: "res847" }))
const h848 = route("PUT", path(lit("res848"), param("id")), async (ctx) => json({ id: 848, key: ctx.params.id }))
const h849 = route("GET", path(lit("res849")), async (ctx) => json({ id: 849, key: "res849" }))
const h850 = route("POST", path(lit("res850"), param("id")), async (ctx) => json({ id: 850, key: ctx.params.id }))
const h851 = route("PUT", path(lit("res851")), async (ctx) => json({ id: 851, key: "res851" }))
const h852 = route("GET", path(lit("res852"), param("id")), async (ctx) => json({ id: 852, key: ctx.params.id }))
const h853 = route("POST", path(lit("res853")), bodySchema, async (ctx) => json({ id: 853, name: ctx.input.name, qty: ctx.input.qty }))
const h854 = route("PUT", path(lit("res854"), param("id")), async (ctx) => json({ id: 854, key: ctx.params.id }))
const h855 = route("GET", path(lit("res855")), async (ctx) => json({ id: 855, key: "res855" }))
const h856 = route("POST", path(lit("res856"), param("id")), async (ctx) => json({ id: 856, key: ctx.params.id }))
const h857 = route("PUT", path(lit("res857")), bodySchema, async (ctx) => json({ id: 857, name: ctx.input.name, qty: ctx.input.qty }))
const h858 = route("GET", path(lit("res858"), param("id")), async (ctx) => json({ id: 858, key: ctx.params.id }))
const h859 = route("POST", path(lit("res859")), async (ctx) => json({ id: 859, key: "res859" }))
const h860 = route("PUT", path(lit("res860"), param("id")), async (ctx) => json({ id: 860, key: ctx.params.id }))
const h861 = route("GET", path(lit("res861")), async (ctx) => json({ id: 861, key: "res861" }))
const h862 = route("POST", path(lit("res862"), param("id")), async (ctx) => json({ id: 862, key: ctx.params.id }))
const h863 = route("PUT", path(lit("res863")), async (ctx) => json({ id: 863, key: "res863" }))
const h864 = route("GET", path(lit("res864"), param("id")), async (ctx) => json({ id: 864, key: ctx.params.id }))
const h865 = route("POST", path(lit("res865")), bodySchema, async (ctx) => json({ id: 865, name: ctx.input.name, qty: ctx.input.qty }))
const h866 = route("PUT", path(lit("res866"), param("id")), async (ctx) => json({ id: 866, key: ctx.params.id }))
const h867 = route("GET", path(lit("res867")), async (ctx) => json({ id: 867, key: "res867" }))
const h868 = route("POST", path(lit("res868"), param("id")), async (ctx) => json({ id: 868, key: ctx.params.id }))
const h869 = route("PUT", path(lit("res869")), bodySchema, async (ctx) => json({ id: 869, name: ctx.input.name, qty: ctx.input.qty }))
const h870 = route("GET", path(lit("res870"), param("id")), async (ctx) => json({ id: 870, key: ctx.params.id }))
const h871 = route("POST", path(lit("res871")), async (ctx) => json({ id: 871, key: "res871" }))
const h872 = route("PUT", path(lit("res872"), param("id")), async (ctx) => json({ id: 872, key: ctx.params.id }))
const h873 = route("GET", path(lit("res873")), async (ctx) => json({ id: 873, key: "res873" }))
const h874 = route("POST", path(lit("res874"), param("id")), async (ctx) => json({ id: 874, key: ctx.params.id }))
const h875 = route("PUT", path(lit("res875")), async (ctx) => json({ id: 875, key: "res875" }))
const h876 = route("GET", path(lit("res876"), param("id")), async (ctx) => json({ id: 876, key: ctx.params.id }))
const h877 = route("POST", path(lit("res877")), bodySchema, async (ctx) => json({ id: 877, name: ctx.input.name, qty: ctx.input.qty }))
const h878 = route("PUT", path(lit("res878"), param("id")), async (ctx) => json({ id: 878, key: ctx.params.id }))
const h879 = route("GET", path(lit("res879")), async (ctx) => json({ id: 879, key: "res879" }))
const h880 = route("POST", path(lit("res880"), param("id")), async (ctx) => json({ id: 880, key: ctx.params.id }))
const h881 = route("PUT", path(lit("res881")), bodySchema, async (ctx) => json({ id: 881, name: ctx.input.name, qty: ctx.input.qty }))
const h882 = route("GET", path(lit("res882"), param("id")), async (ctx) => json({ id: 882, key: ctx.params.id }))
const h883 = route("POST", path(lit("res883")), async (ctx) => json({ id: 883, key: "res883" }))
const h884 = route("PUT", path(lit("res884"), param("id")), async (ctx) => json({ id: 884, key: ctx.params.id }))
const h885 = route("GET", path(lit("res885")), async (ctx) => json({ id: 885, key: "res885" }))
const h886 = route("POST", path(lit("res886"), param("id")), async (ctx) => json({ id: 886, key: ctx.params.id }))
const h887 = route("PUT", path(lit("res887")), async (ctx) => json({ id: 887, key: "res887" }))
const h888 = route("GET", path(lit("res888"), param("id")), async (ctx) => json({ id: 888, key: ctx.params.id }))
const h889 = route("POST", path(lit("res889")), bodySchema, async (ctx) => json({ id: 889, name: ctx.input.name, qty: ctx.input.qty }))
const h890 = route("PUT", path(lit("res890"), param("id")), async (ctx) => json({ id: 890, key: ctx.params.id }))
const h891 = route("GET", path(lit("res891")), async (ctx) => json({ id: 891, key: "res891" }))
const h892 = route("POST", path(lit("res892"), param("id")), async (ctx) => json({ id: 892, key: ctx.params.id }))
const h893 = route("PUT", path(lit("res893")), bodySchema, async (ctx) => json({ id: 893, name: ctx.input.name, qty: ctx.input.qty }))
const h894 = route("GET", path(lit("res894"), param("id")), async (ctx) => json({ id: 894, key: ctx.params.id }))
const h895 = route("POST", path(lit("res895")), async (ctx) => json({ id: 895, key: "res895" }))
const h896 = route("PUT", path(lit("res896"), param("id")), async (ctx) => json({ id: 896, key: ctx.params.id }))
const h897 = route("GET", path(lit("res897")), async (ctx) => json({ id: 897, key: "res897" }))
const h898 = route("POST", path(lit("res898"), param("id")), async (ctx) => json({ id: 898, key: ctx.params.id }))
