...
| `@rhi-zone/fractal-http-api-projector` | HTTP kit: `path`, `methods`, `param`, `query`, `header`, `body`, `validate`, `route`, `serve`; OpenAPI 3.1 projection (`toOpenApi`) auto-served at `/openapi.json` by `createFetch` |
