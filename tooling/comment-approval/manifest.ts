...
export function approveComments(manifest: Manifest, comments: readonly ExtractedComment[], now: () => string = () => new Date().toISOString()): Manifest {
...
export function parseManifest(json: string): Manifest {
  ...
  if (typeof parsed !== "object" || parsed === null || !("approved" in parsed)) {
    throw new Error("malformed comment-approval manifest: expected an object with an \"approved\" key")
  }
