...
// is T`, so the file typechecks clean under `strict` (see compile.ts's doc
// comment for how the untyped TypeBox-compiler body underneath stays
// strict-safe) and a consumer narrows `.value` off `.kind === "ok"` instead
// of reading `unknown`.
