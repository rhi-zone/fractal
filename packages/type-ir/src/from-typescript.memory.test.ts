...
//
// Incident this guards against: `busiless`'s 16-slice validator codegen
...
// itself — measured against the real busiless repo, ONE slice's Program
...
// kernel dmesg log).
//
// This file cannot depend on the real busiless repo (wrong direction of
...
// busiless's 16 slices, which all transitively import the same
