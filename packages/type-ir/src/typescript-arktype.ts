...
function withChainedMeta(e: Emitted, meta: Readonly<Record<string, unknown>>): Emitted {
  ...
  if (typeof meta.description === "string")
    chain.push(`.describe(${JSON.stringify(meta.description)})`);
...
function emitRef(ref: TypeRef): Emitted {
  ...
  const base: Emitted =
    converter === undefined ? { text: "unknown", mode: "word" } : converter(ref.shape, ref.meta);
