...
describe("leaf types", () => {
  test("boolean", () => {
    expect(toProtoField(t(types.boolean))).toEqual({
      type: "bool",
      repeated: false,
      optional: false,
    });
  ...
  test("string", () => {
    expect(toProtoField(t(types.string))).toEqual({
      type: "string",
      repeated: false,
      optional: false,
    });
...
describe("string subtypes fall back to string", () => {
  ...
  test("email", () => {
    expect(toProtoField(email()).type).toBe("string");
  });
...
describe("union", () => {
  test("degrades to google.protobuf.Any", () => {
    expect(toProtoField(t(types.union([t(types.string), int32()]))).type).toBe(
      "google.protobuf.Any",
    );
  });
});
...
describe("deprecated", () => {
  ...
  test("renders as a bracketed field option", () => {
    const message = toProtoMessage(
      "Person",
      t(types.object({ name: t(types.string, { deprecated: true }) })),
    );
...
describe("description", () => {
  ...
  test("renders as a // comment above the message", () => {
    const message = toProtoMessage(
      "Person",
      t(types.object({ name: t(types.string) }), { description: "a person" }),
    );
    const rendered = renderProto([message]);
    ...
    expect(message.nestedMessages).toEqual([
      {
        name: "Address",
        fields: [
          { name: "city", field: { type: "string", repeated: false, optional: false }, number: 1 },
        ],
      },
    ]);
  });
    ...
    expect(message.oneofs).toEqual([
      {
        ...
        fields: [
          {
            name: "success",
            field: { type: "Success", repeated: false, optional: false },
            number: 1,
          },
    ...
    expect(message.oneofs).toEqual([
      {
        ...
        fields: [
          {
            name: "variant1",
            field: { type: "Variant1", repeated: false, optional: false },
            number: 1,
          },
          {
            name: "variant2",
            field: { type: "Variant2", repeated: false, optional: false },
            number: 2,
          },
        ],
      },
    ...
    expect(message.oneofs).toEqual([
      {
        ...
        fields: [
          ...
          {
            name: "variant2",
            field: { type: "string", repeated: false, optional: false },
            number: 2,
          },
          {
            name: "variant3",
            field: { type: "int32", repeated: false, optional: false },
            number: 3,
          },
        ],
      },
    ...
    expect(service.messages).toEqual([
      {
        ...
        fields: [
          {
            name: "amount",
            field: { type: "double", repeated: false, optional: false },
            number: 1,
          },
        ],
      },
