...
describe("intersection", () => {
  test("inline reference uses meta.typeName", () => {
    const ref = t(types.intersection([t(types.object({ a: t(types.string) }))]), {
      typeName: "Combined",
    });
...
describe("object", () => {
  ...
  test("method-typed field renders with arguments", () => {
    ...
    expect(toGraphQLType("Greeter", ref)).toBe(
...
describe("description", () => {
  ...
  test("field-level description renders above the field", () => {
    const ref = t(
      types.object({ id: withMeta(t(types.string), { description: "Unique identifier" }) }),
    );
    expect(toGraphQLType("User", ref)).toBe(
      'type User {\n  """Unique identifier"""\n  id: String!\n}',
    );
...
describe("deprecated", () => {
  ...
  test("meta.deprecatedReason adds a reason argument", () => {
    const ref = t(
      types.object({
        old: withMeta(t(types.string), {
          deprecated: true,
          deprecatedReason: "use `newField` instead",
        }),
      }),
    );
    expect(toGraphQLType("User", ref)).toBe(
