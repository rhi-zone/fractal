// packages/codegen/src/compile.ts — @rhi-zone/fractal-codegen
//
...
import { resolve, type TypeRef, type TypeShape } from "@rhi-zone/fractal-type-ir"
...
export function compileValidatorModule(entries: readonly { name: string; ref: TypeRef }[]): string {
  const lines: string[] = []
  lines.push("// AUTO-GENERATED by @rhi-zone/fractal-codegen. Do not edit by hand.")
  lines.push("")
