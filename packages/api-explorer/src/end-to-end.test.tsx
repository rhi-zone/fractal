 ...
 * intended to emit. */
function propsFromGeneratedPage(mdx: string): { method: string; path: string; responseSchema: unknown } {
    ...
    act(() => {
      root.render(
        <ApiExplorerFetchProvider fetch={realFetch}>
          <ApiExplorer method={props.method} path={props.path} responseSchema={props.responseSchema as never} />
